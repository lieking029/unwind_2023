        ...
        <div class="card-body rooms-container">
            ...
            <div class="row appended-row mt-3">
                <div class="p-3 row">
                    ...
                    <div class="col">
                        <a href="{{ route('room.destroy', $resort->id) }}" class="btn btn-danger" style="float: right"><i class="fas fa-trash"></i></a>
                    </div>
                </div>
                ...
                <div class="col mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="rooms[{{ $loop->index }}][max_guest_count]" value="{{ $resort->max_guest_count }}" class="form-control" placeholder="Max Guest Count">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="">Bath Count</label>
                        <div class="input-group">
                            <input type="text" name="rooms[{{ $loop->index }}][bath_count]" value="{{ $resort->bath_count }}" class="form-control" placeholder="Bath Count">
                        </div>
                    </div>
                </div>
                <div class="col mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="rooms[{{ $loop->index }}][bed_count]" value="{{ $resort->bed_count }}" class="form-control" placeholder="Bed Count">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="">Room Price</label>
                        <div class="input-group">
                            <input type="text" name="rooms[{{ $loop->index }}][price]" value="{{ $resort->price }}" class="form-control" placeholder="Price">
                        </div>
                    </div>
                </div>
            </div>

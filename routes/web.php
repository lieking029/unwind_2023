...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:merchant')->group(function () {
        ...
        Route::post('room/{property}', [RoomController::class, 'store'])->name('room.store');
        Route::get('room/{property}', [RoomController::class, 'edit'])->name('room.edit');
        Route::post('room/{property}/update', [RoomController::class, 'update'])->name('room.update');
